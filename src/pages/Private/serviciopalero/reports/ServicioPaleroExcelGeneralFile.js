...
export const ServicioPaleroExcelGeneralFile = (data) => {
  ...
  mergedCellTitle.value = "Información del Reporte General de Servicio de Palero";
  mergedCellTitle.font = boldStyle;

  // Separador vacío
  worksheet.addRow([])
  const headerRowFinancia = worksheet.addRow([
    'FECHA', 'PALERO', 'PRECIO', 'PESO BRUTO', 'TOTAL', 'ESTADO',
  ])
